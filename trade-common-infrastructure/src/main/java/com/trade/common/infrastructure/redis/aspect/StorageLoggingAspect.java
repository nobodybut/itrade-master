...
import com.trade.common.infrastructure.redis.utils.MethodUtils;
...
public class StorageLoggingAspect {
	...
	@Around("@within(com.trade.common.infrastructure.redis.aspect.StorageLogging) || @annotation(com.trade.common.infrastructure.redis.aspect.StorageLogging)")
