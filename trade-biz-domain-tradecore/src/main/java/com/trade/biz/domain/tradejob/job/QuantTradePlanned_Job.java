...
@Component
public class QuantTradePlanned_Job extends AbstractQuartzJob {
	...
	protected void execute() {
		QuantTradePlannedManager quantTradePlannedManager = (QuantTradePlannedManager) ApplicationContextUtils.getBean("quantTradePlannedManager");
